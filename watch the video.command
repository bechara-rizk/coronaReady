...
url = "https://youtu.be/Ed3AmgRheaI"  #cette variable definie le lien qui va etre ouvert par la fonction, il peut etre un lien externe (de l'internet) ou local
open(url,new=new)  #avec la fonction importee et les variables definies on va ouvrir la video qui montre presente notre projet dans une nouvelle fenetre du moteur de recherche si possible
